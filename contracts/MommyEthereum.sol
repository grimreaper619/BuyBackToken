...
contract MommyEthereum is ERC20, Ownable {
    ...
    MommyDividendTracker public dividendTracker;

    address private constant deadWallet = address(0xdead);

    address private constant ETH =
        address(0x77c21c770Db1156e271a3516F89380BA53D594FA); //ETH
    address public buybackToken =
        address(0x77c21c770Db1156e271a3516F89380BA53D594FA);
    ...
    constructor() ERC20("Mommy Ethereum", "METH") {

        sellFee.rewardFee = 30;
        sellFee.marketingFee = 10;
        sellFee.buybackFee = 20;
        totalSellFee = 60;
        ...
        dividendTracker = new MommyDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "Mommy: The dividend tracker already has that address"
        );

        MommyDividendTracker newDividendTracker = MommyDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "Mommy: The new dividend tracker must be owned by the Mommy token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "Mommy: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "Mommy: Account is already excluded"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setSellFee(
        ...
        sellFee.rewardFee = rewards;
        sellFee.marketingFee = marketing;
        sellFee.buybackFee = buyback;
        totalSellFee = rewards + marketing + buyback;
    }
    ...
    function setBuylFee(
        ...
        totalBuyFee = rewards + marketing + buyback;
    }
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "Mommy: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "Mommy: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "Mommy: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "Mommy: Cannot update gasForProcessing to same value"
        );
    ...
    function _transfer(
        ...
        if (
            ...
            swapTokensForTokens(buybackTokens,buybackToken,deadWallet);
...
contract MommyDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor()
        DividendPayingToken("Mommy_Dividen_Tracker", "Mommy_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "Mommy_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Mommy_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Mommy contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "Mommy_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "Mommy_Dividend_Tracker: Cannot update claimWait to same value"
        );
